...
test_tertiary_fuels = \
    ...
    'Organic_collection',
    'No_collection',    'Inorganic_source_separation',
...
#
codes_list_techs_all = codes_list_techs_primary + codes_list_techs_secondary + codes_list_techs_demands
#
###############################################################
...
df_base_year_names = [ 'Primary', 'Secondary', 'Demand Techs']
...
df_projection_names = [ 'Primary', 'Secondary', 'Demand Techs']
