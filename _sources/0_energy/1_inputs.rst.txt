...
La :numref:`table_inputs_energy` presenta una síntesis de las fuentes de información
utilizadas para la construcción del Escenario Tendencial Nacional del
sector Energía. Como se puede notar, y conforme la instrucción
proporcionada por el Ministerio del Ambiente y Energía, el proceso de
modelado que da lugar al Escenario Tendencial Nacional integra
información proveniente tanto del modelo OSeMOSYS que da soporte al
PLANMICC como del modelo OSeMOSYS que da soporte a la Segunda NDC. En
todos los casos, se garantizan la consistencia con las Directrices del
IPCC (2006), su refinamiento de 2019 y el Inventario Nacional de GEI
2022 de la Quinta Comunicación Nacional, segundo reporte bienal de
...
.. table:: Fuentes de información utilizadas para el proceso de modelado del Escenario Tendencial Nacional del sector Energía
   ...
   |           | de operación, energía generada  | Invernadero (INGEI de la      |
   |           | (GWh)                           | quinta comunicación nacional  |
   |           |                                 | 1994-2022)                    |
   +-----------+---------------------------------+-------------------------------+
   | 2         | Demanda de energía por fuente   | Balance de Energía Nacional   |
   |           | energética en el sector         | 2024, INGEI (1994-2022)       |
   |           | industrial y construcción (TJ)  | (5CN/2RBT, 2024)              |
   +-----------+---------------------------------+-------------------------------+
   | 3         | Demanda de energía por fuente   | Balance de Energía Nacional   |
   |           | energética por tipo de          | 2024, ANT, INGEI (1994-2022)  |
   |           | transporte: terrestre           |                               |
   |           | (pasajeros y carga), marítimo,  | (5CN/2RBT,, 2024)             |
   |           | aéreo (TJ)                      |                               |
   +-----------+---------------------------------+-------------------------------+
   ...
   |           | servicios públicos,             |                               |
   |           | agricultura/pesca/minería (TJ)  | (5CN/2RBT,, 2024)             |
   +-----------+---------------------------------+-------------------------------+
   | 5         | Demanda de energía por tipo de  | Balance de Energía Nacional   |
   |           | fuente energética en otros      | 2024, INGEI de la 5ta         |
   |           | sectores no clasificados (TJ)   | (1994-2022) (5CN/2RBT, 2024)  |
   +-----------+---------------------------------+-------------------------------+
   ...
   +-----------+---------------------------------+-------------------------------+
   | 9         | Vehículos matriculados por tipo | Agencia Nacional de Tránsit   |
   |           | y año, clasificación NTE INEN   | (PLANMICC)                    |
   |           | 2656                            |                               |
   +-----------+---------------------------------+-------------------------------+

La :numref:`table_inputs_params` presenta los parámetros de modelación y supuestos adoptados
para la construcción del Escenario Tendencial Nacional del sector
Energía. La :numref:`table_inputs_params` además establece los criterios utilizados para
proyectar la generación eléctrica, producción petrolera, demanda de
energía, transporte, variables económicas y demográficas, así como la
métrica y factores de emisión empleados en el modelo.

.. _table_inputs_params:
.. table:: Fuentes de información utilizadas para parametrizar el Escenario Tendencial Nacional del sector Energía
   ...
   |     |                      |   generación basada en tendencias      |
   |     |                      |   históricas sin políticas de promoción|
   ...
   |     |                      |   gestión de la energía conforme       |
   |     |                      |   la norma ISO 50001.                  |
   +-----+----------------------+----------------------------------------+
   ...
   |     |                      |   carga media.                         |
   +-----+----------------------+----------------------------------------+
   | 6   | Tasas de crecimiento | - Crecimiento del PIB según            |
   |     | económico            |   proyecciones consideradas            |
   |     |                      |   en el PLANMICC.                      |
   +-----+----------------------+----------------------------------------+
   | 7   | Tasas de crecimiento | - Proyecciones demográficas del INEC.  |
   |     | poblacional          | - Aumento poblacional influye          |
   ...
   |     | base                 | - Línea base: INGEI 2010 de la         |
   |     |                      |   Quinta Comunicación Nacional y Primer|
   |     |                      |   Reporte Bienal de Transparencia.     |
   +-----+----------------------+----------------------------------------+
